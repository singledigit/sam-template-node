...
This is a sample template for start-point - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name start-point --tail
```
...
```bash
aws cloudformation delete-stack --stack-name start-point
```
